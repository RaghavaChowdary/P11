...
o = open("h1map_output.txt", "w") # open file, write - just our key, value pairs
for line in f:  
    ...
    if len(data) == 11:
        ...
        print "{0}\t{1}".format(CASE_STATUS, YEAR)
        o.write("{0}\t{1}\n".format(CASE_STATUS, YEAR))
f.close()
o.close()
n = open("h1map_output.txt","r")  # open file, read-only
